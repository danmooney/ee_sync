...
<div class="remote-site-settings-payload-container">
    <label for="remote_site_settings_payload">Want remote sites to get information from this local site?  Copy the encoded settings payload below and paste it into a new remote site configuration on another Syncee installation.</label>
