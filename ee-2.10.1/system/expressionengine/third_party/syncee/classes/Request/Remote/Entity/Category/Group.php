...
class Syncee_Request_Remote_Entity_Category_Group extends Syncee_Request_Remote_Entity_Abstract
{
    ...
    {
        $rows = ee()->db->select('*')->from('category_groups')->get()->result_array();
